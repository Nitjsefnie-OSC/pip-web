...
export default function LearnPage() {
  ...
  return (
    ...
    >
      ...
      {/* The practice half. Separate from the guides rather than another card
          in that list: reading and doing are different things, and the guides
          list is the thing a search brought most people here for. */}
      <section className="mt-12">
        ...
        >
          ...
          <p className="mt-1.5 text-md leading-relaxed text-muted-foreground">
            One question at a time, with the arithmetic underneath it. No score and no counter.
          </p>
        </Link>
      </section>
    </LegalPage>
